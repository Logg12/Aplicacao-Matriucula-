...
// busca pra a criacao do grafico

// $buscaData = "SELECT datahora_criacao, COUNT(datahora_criacao),COUNT(MONTH(datahora_criacao)) 
//               FROM usuario 
//               group by MONTH(datahora_criacao)";
// $resultBuscaData = $connectionDb->query($buscaData);
// if (mysqli_num_rows($resultBuscaData) > 0) {
//     while ($linha = mysqli_fetch_assoc($resultBuscaData)) {
//         echo $linha["MONTH(datahora_criacao)"];
//     }
// }
