                ...
                <div class="col-xl-7 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2 ps-4 bg-white d-flex justify-content-start flex-column">
                            ...
                            <img src="../../assets/img/logoIF.png" style="width:25%" alt="Logo IFMG">
                            <h1 class="h2 text-if-secondary">Cadastro de Matrícula</h1>
                            <p>
                                <?php echo $status ?>
                            </p>
                        </div>
                        <div class="card-body p-3">
                            <form method="post">
                                <div class="form-group row d-flex justify-content-center align-items-center  ">
                                    <div class="col-sm-11 ">
                                        <label for="inputName" class="col-sm-4 col-form-label text-start ">Nome
                                            :</label>
                                    </div>

                                    <div class="col-sm-11 ">
                                        <input type="text" class="form-control" id="inputName" name="nome"
                                            placeholder="Jõao" value="<?php echo $nome; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row d-flex justify-content-center align-items-center  ">
                                    <div class="col-sm-11 ">
                                        <label for="inputName2" class="col-sm-4 col-form-label text-start">Sobrenome
                                            :</label>
                                    </div>

                                    <div class="col-sm-11 ">
                                        <input type="text" class="form-control" id="inputName2" name="sobrenome"
                                            placeholder="Silva" value="<?php echo $sobrenome; ?>" required>
                                    </div>
                                </div>

                                <div class="form-group row d-flex justify-content-center align-items-center  ">
                                    <div class="col-sm-11 ">
                                        <label for="inputCPF3" class="col-sm-4 col-form-label text-start ">CPF
                                            :</label>
                                    </div>

                                    <div class="col-sm-11 ">
                                        <input class="form-control" type="number_format" name="cpfMatricula"
                                            oninput="mascara_cpf(this)" value="<?php echo $cpf; ?>" id="cpfMatricula"
                                            name="cpf" required>
                                    </div>
                                </div>
                                <div class="form-group row d-flex justify-content-center align-items-center  ">
                                    <div class="col-sm-11 ">
                                        <label for="inputEmail3" class="col-sm-4 col-form-label text-start">Email
                                            Cadastrado :</label>
                                    </div>
                                ...
                                <div class="form-group row row d-flex justify-content-center align-items-center">
                                    <div class="col-sm-11 ">
                                        <label for="inputEmail3" class="col-sm-4 col-form-label text-start ">Senha
                                            Cadastrada :</label>
                                    </div>
                                    <div class="col-sm-11">
                                ...
                                <div class="form-group row  d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col-sm-11">
                                        <table class="table  caption-top ">
                                            <caption><b>Materias disponíveis para matricular-se :</b></caption>
                                            <thead class="table-light">
                                                <td>Disicplinas</td>
                                                <td>Carga Horaria</td>
                                                <td>Adicionar à Matrícula</td>
                                            </thead>
                                            <tbody>
                                ...
                                <div class="form-group row d-flex justify-content-center align-items-center">
                                    <div class="col-sm-11 d-flex justify-content-center align-items-center">
                                        <input type="submit" name="matricular" id="btnMatricular" value="Matricular-se"
                                            class="btn if-bg btn-lg">
                                    </div>
                                </div>
                            </form>
                        </div>
